...
```
Error: ArgumentError: Package CUTEst not found in current path:
- Run `import Pkg; Pkg.add("CUTEst")` to install the CUTEst package.
```
...
```
Error: UndefVarError: CUTEst not defined
```
