...
```
Error: ArgumentError: Package LinearOperators not found in current path:
- Run `import Pkg; Pkg.add("LinearOperators")` to install the LinearOperato
rs package.
```
...
```
Error: UndefVarError: opCholesky not defined
```
...
```
Error: UndefVarError: dft not defined
```
...
```
Error: UndefVarError: op2 not defined
```
...
```
Error: ArgumentError: Package Krylov not found in current path:
- Run `import Pkg; Pkg.add("Krylov")` to install the Krylov package.
```
...
```
Error: UndefVarError: LBFGSOperator not defined
```
...
```
Error: UndefVarError: opRestriction not defined
```
...
```
Error: UndefVarError: opExtension not defined
```
...
```
Error: UndefVarError: opA not defined
```
